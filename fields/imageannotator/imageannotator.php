...
class ImageannotatorField extends BaseField {
  ...
  public function headline() {
    ...
    if(!$this->readonly && (is_null($this->limit) || (is_int($this->limit) && $entries->count() < $this->limit))) {
      ...
      $add->data('modal', true);
      $add->attr('href', purl($this->model, 'field/' . $this->name . '/imageannotator/add'));
  ...
  public function url($action) {
    return purl($this->model(), 'field/' . $this->name() . '/imageannotator/' . $action);
  }  
